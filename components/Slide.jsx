    ...
    <div className="w-full h-auto">
      <div className="max-w-[95%] mx-auto flex">
        <div className="w-[5%] inline-flex items-center ">
          <GoChevronLeft className="h-14 w-14 " />
        </div>
        <div className="w-[90%]  my-3 grid grid-cols-3 gap-3 pl-4 ">
          ...
          <div className="xs:col-span-2 col-span-3 flex flex-col">
            ...
            <h1 className="text-2xl font-bold ">about how they teach.</h1>
        ...
        <div className="w-[5%] inline-flex items-center justify-end ">
          <GoChevronRight className="h-14 w-14 " />
        </div>
      </div>
    </div>
  );
